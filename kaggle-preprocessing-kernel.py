...
This is a MATLAB script. Download the latest version from https://github.com/guevaracodina/raman-diabetes/
...
% Learning Tools 
% Edgar Guevara, Juan Carlos Torres-Galv�n, Miguel G. Ram�rez-El�as,
% Claudia Luevano-Contreras and Francisco Javier Gonz�lez
...
'''
print('Please cite: E. Guevara, J. C. Torres-Galván, M. G. Ramírez-Elías, C. Luévano-Contreras, and F. J. González, “Use of Raman Spectroscopy to Screen Diabetes Mellitus with Machine Learning Tools,” Biomedical Optics Express, in press. This is a MATLAB script. Download the latest version from https://github.com/guevaracodina/raman-diabetes/ The dataset of our work where the application of portable Raman spectroscopy coupled with several supervised machine-learning techniques, is used to discern between diabetic patients (DM2) and healthy controls (Ctrl), with a high degree of accuracy. Download dataset from: https://www.kaggle.com/codina/raman-spectroscopy-of-diabetes')